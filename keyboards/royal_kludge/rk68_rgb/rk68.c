    ...
    if (record->event.pressed) {
        switch(keycode) {
            ...
            case BT_PROFILE3:
                ...
                break;
            case BT_PROFILE4:
                curr_bt_profile = RK_BT_PROFILE_4;
                iton_bt_switch_profile(RK_BT_PROFILE_4);
                break;
            case BT_PROFILE5:
                curr_bt_profile = RK_BT_PROFILE_5;
                iton_bt_switch_profile(RK_BT_PROFILE_5);
                break;
            case BT_PAIR:
                if(curr_bt_profile >= RK_BT_PROFILE_1 && curr_bt_profile <= RK_BT_PROFILE_5)
