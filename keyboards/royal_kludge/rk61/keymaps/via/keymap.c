...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MAC] = LAYOUT_60_ansi(
        ...
        KC_LCTL,    KC_LALT,    KC_LCMD,                                        KC_SPC,                             KC_RCMD,    KC_RALT,    KC_RCTL,                MO(_MACFN)
    ),
    /* Mac FN
     * ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───────┬───┐
    ...
    [_MACFN] = LAYOUT_60_ansi(
        ...
        _______,    AG_SWAP,    AG_NORM,    _______,    _______,    _______,    KC_INS,     KC_HOME,    KC_PGUP,    _______,    RGB_SPD,    RGB_SPI,                _______,   
        _______,                KC_MUTE,    KC_VOLD,    KC_VOLU,    KC_MPRV,    KC_MNXT,    KC_DEL,     KC_END,     KC_PGDN,    RGB_HUI,    KC_UP,      MO(_FNS),   
